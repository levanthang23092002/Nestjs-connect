...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.createUser = function (user) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersService.create(user)];
            });
        });
    };
    ...
    UsersController.prototype.updateBook = function (id, user) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersService.updateById(id, user)];
            });
        });
    };
    UsersController.prototype.deleteBook = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersService.deleteById(id)];
            });
        });
    };
    __decorate([
    ...
    ], UsersController.prototype, "updateBook");
    __decorate([
        common_1.Delete(':id'),
        __param(0, common_1.Param('id'))
    ], UsersController.prototype, "deleteBook");
